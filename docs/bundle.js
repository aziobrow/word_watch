...
const getTopWord = () => {
  ...
  .then((wordInfo) => {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('h3').append(`${word} (${count})`)
  })
...
const countWords = (event) => {
  let paragraph = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('textarea').val()
...
const renderWordle = (sortedWords) => {
  sortedWords.forEach((word) => {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.word-count').append(`<p style="font-size:${word[1]}em">${word[0]}</p>`)
  })
}
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  getTopWord()
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#count-paragraph').on('click', countWords)
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.text-submission').on('keyup', onEnter)
})
